...
var madlib = `My ${body} looks good today.`;
var madlib = `The ${girl} eats at the table.`;
var madlib = `I went to ${work} in the morning.`;
var madlib = `I need to ${play} or I'll get mean.`;
