...
let face = "front"; /*Between the quotation marks, 
...
let red = "primary"; //repeat the instructions with the word "red" (keep in the form of a noun)

let brain = "organ"; //repeat the instructions for the word "brain"

let masculine = "dirty"; //define 'masculine' in ADJECCTIVE form, so 
//you could sub it into a sentence that uses the word as an ADJECTIVE

let think = "inquire"; //define 'think' in VERB form,
